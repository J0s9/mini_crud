...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href=""><span>[</span>ALMACEN<span>]</span></a></div>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item" href="index.html">ALMACEN</a>
          <span class="breadcrumb-item active">Nuevo Producto</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Almacen de Productos</h4>
      ...
      <div class="br-section-wrapper">
          <h6 class="tx-gray-700 tx-uppercase tx-bold tx-14 mg-b-10">Mantenimiento Producto</h6>
